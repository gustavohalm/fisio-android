...
import com.gustavohalm.fisio.Fragments.ProcedureFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_patient) {
            ...
            FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
            fragmentTransaction.replace(R.id.FrameLayout, diagnosticFragment);
            fragmentTransaction.commit();

        } else if (id == R.id.nav_procedure) {
            ProcedureFragment procedureFragment = new ProcedureFragment();
            FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
            fragmentTransaction.replace(R.id.FrameLayout, procedureFragment );
            fragmentTransaction.commit();
